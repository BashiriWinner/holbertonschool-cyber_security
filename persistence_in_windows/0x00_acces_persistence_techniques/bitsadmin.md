...
[Application Layer] ↓ [BitsAdmin.exe / PowerShell BITS cmdlets] ↓ [BITS Service (qmgr.dll)] ↓ [BITS Job Manager] ↓ [HTTP(S) / SMB / UNC Protocol Handlers] ↓ [Network Layer]
...
Qanuni Windows xidməti: Sistem tərəfindən etibarlı komponent kimi qəbul edilir
Yüksək imtiyazlar: SYSTEM səviyyəsində işləyir
Davamlılıq: Reboot-lar arasında da aktiv qalır
Stealth: Trafik hissə-hissə ötürüldüyü üçün şəbəkə monitorinqindən yayına bilir
Sadə implementasiya: Command-line vasitəsilə asanlıqla yaradıla bilər
